...
public class Nomes {
	...
	public Set<Inventor> inventores;

	public Set<Depositante> depositantes;

	public Nomes() {
		inventores = new HashSet<Inventor>();
		depositantes = new HashSet<Depositante>();
	}

	public boolean addInventor(Inventor i) {
		if (inventores.add(i)) {
			return true;
		}
		return false;
	...
	public boolean addDepositante(Depositante r) {
		if (depositantes.add(r)) {
			return true;
		}
		return false;
	}
	...
	public void escrever() {
		...
		for (Inventor i : inventores) {
			System.out.print(i.getNome() + " - " + i.getNacionalidade());
		}
		System.out.println("\nDepositantes");
		for (Depositante d : depositantes) {
			System.out.println(d.getNome() + " - " + d.getNacionalidade());
		}
		System.out.println("");
	}
	...
	public Set<Depositante> getDepositantes() {
		return depositantes;
	}
	...
	public void setDepositantes(Set<Depositante> depositantes) {
